...
export function CalmingBreath({ onBack }) {
  const {
    isRunning,
    currentPhase,
    phaseLabel,
    ...
    pause,
    reset,
  } = useBreathTimer(CALMING_PATTERN)
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <h2 className="text-2xl font-light mb-2">Calming Breath</h2>
      <p className="text-slate-400 text-sm mb-8">Simple inhale-exhale flow</p>
      ...
      <div className="mt-12 p-6 rounded-2xl bg-white/5 border border-white/10 max-w-sm">
        ...
        <div className="grid grid-cols-2 gap-2 text-center text-xs">
          ...
          <div className="p-2 rounded-lg bg-emerald-500/20 text-emerald-300">
            ...
            <p className="text-lg mt-1">6s</p>
          </div>
        </div>
        <p className="text-slate-500 text-xs mt-3 text-center">Extended exhale activates relaxation response</p>
      </div>
    </div>
  )
}
