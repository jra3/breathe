...
export function EnergyBreath({ onBack }) {
  const {
    isRunning,
    currentPhase,
    phaseLabel,
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <h2 className="text-2xl font-light mb-2">Energizing Breath</h2>
      <p className="text-slate-400 text-sm mb-8">Quick awakening rhythm</p>
      ...
      <div className="mt-12 p-6 rounded-2xl bg-white/5 border border-white/10 max-w-sm">
        ...
        <p className="text-slate-500 text-xs mt-3 text-center">Fast rhythm to boost alertness</p>
      </div>
    </div>
  )
}
